...
namespace Geex.Common.Logging
{
    ...
    public class RollingFileLoggerProvider : BatchingLoggerProvider
    {
        ...
        /// <summary>
        /// Creates an instance of the <see cref="RollingFileLoggerProvider" /> 
        /// </summary>
        /// <param name="options">The options object controlling the logger</param>
        public RollingFileLoggerProvider(IOptionsMonitor<RollingFileLoggerOptions> options) : base(options)
        {
        ...
        /// <summary>
        /// Deletes old log files, keeping a number of files defined by <see cref="RollingFileLoggerOptions.RetainedFileCountLimit" />
        /// </summary>
