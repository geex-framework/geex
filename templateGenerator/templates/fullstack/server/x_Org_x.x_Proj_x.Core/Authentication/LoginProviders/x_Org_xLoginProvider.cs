...
namespace x_Org_x.x_Proj_x.Core.Authentication.LoginProviders
{
    /// <summary>
    /// Geex登陆Provider
    /// </summary>
    public class x_Org_xLoginProvider : IExternalLoginProvider
    {
        private readonly x_Org_xLoginConfiguration _configuration;
        private readonly HttpClient _httpClient;
        private readonly Task<DiscoveryDocumentResponse> _disc;
        private readonly ILogger<x_Org_xLoginProvider> _logger;
        private readonly DbContext _dbContext;
        private readonly IMediator _mediator;
        private readonly ICurrentTenant _currentTenant;

        public LoginProviderEnum Provider { get; } = x_Proj_xLoginProviderEnum.x_Org_x;

        public x_Org_xLoginProvider(ILogger<x_Org_xLoginProvider> logger, IConfiguration configuration, DbContext dbContext, IMediator mediator, ICurrentTenant currentTenant)
        {
            this._configuration = new x_Org_xLoginConfiguration();
            configuration.GetSection("Authentication:External:x_Org_x").Bind(this._configuration);
            _logger = logger;
    ...
    /// kufore登陆配置
    /// </summary>
    public class x_Org_xLoginConfiguration
    {
        /// <summary>
        /// 是否启用
        /// </summary>
        ...
        /// <summary>
        /// <example>https://x_proj_x.local.x_org_x.cn/passport/callback</example>
        /// </summary>
