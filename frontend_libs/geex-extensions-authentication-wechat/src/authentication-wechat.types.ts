...
export type AuthenticationWechatRenderOverrides = Partial<GeexAuthenticationWechatOptions> & {
  state?: string;
};

export interface AuthenticationWechatModule extends GeexModule<{
  getConfig(overrides?: Partial<GeexAuthenticationWechatOptions>): GeexAuthenticationWechatOptions;
  buildAuthorizeUrl(overrides?: AuthenticationWechatRenderOverrides): string;
  renderQr(overrides?: AuthenticationWechatRenderOverrides): Promise<void>;
...
declare module "@geexcode/geex-angular" {
  interface GeexModuleMap {
    authenticationWechat: AuthenticationWechatModule;
  }
}
