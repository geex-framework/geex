...
import type {
  ...
  AuthenticationWechatRenderOverrides,
  EstablishSessionOptions,
  GeexAuthenticationWechatOptions,
  ResolveLoginResult,
  WechatLoginProvider,
} from "./authentication-wechat.types";
...
export function createAuthenticationWechatModule(
  injector: Injector,
  ...
  const module: AuthenticationWechatModule = {
    getConfig,
    buildAuthorizeUrl: (overrides?: AuthenticationWechatRenderOverrides) => {
    ...
    renderQr: async (overrides?: AuthenticationWechatRenderOverrides) => {
