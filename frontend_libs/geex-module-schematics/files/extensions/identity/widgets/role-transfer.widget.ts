...
import { ControlUIWidget, SFSchemaEnum, SFValue, getData, SFSchemaEnumType, SFUISchemaItem } from "@delon/form";
...
export class RoleTransferWidget extends ControlUIWidget<RoleTransferWidgetSchema> implements OnInit {
  /* 用于注册小部件 KEY 值 */
