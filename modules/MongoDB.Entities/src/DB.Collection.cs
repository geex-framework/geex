...
namespace MongoDB.Entities
{
    public static partial class DB
    {
        ...
        public static IMongoCollection<T> Collection<T>() where T : IEntityBase
        {
        ...
        public static string CollectionName<T>() where T : IEntityBase
        {
        ...
        public static async Task DropCollectionAsync<T>(IClientSessionHandle session = null) where T : IEntityBase
        {
