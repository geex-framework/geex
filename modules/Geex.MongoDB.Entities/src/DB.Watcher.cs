...
namespace MongoDB.Entities
{
    public static partial class DB
    {
        ...
        public static Watcher<T> Watcher<T>(string name) where T : IEntityBase
        {
        ...
        public static IEnumerable<Watcher<T>> Watchers<T>() where T : IEntityBase => Cache<T>.Watchers.Values;
    }
}
